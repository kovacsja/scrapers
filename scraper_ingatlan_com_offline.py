...
with open(
    "/home/honfi/Documents/Python/misc_projects/webscrape_selenium/Eladó lakások Budapest pesti oldal - ingatlan.com.html",
    "r",
) as f:
...
parse_listings(soup).to_csv("minta2.csv")
